package net.napilnik.someapp.serversimulator.ServerSimulator;
...
import net.napilnik.someapp.serversimulator.ServerSimulator.app.Application;
...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        final Application app = new Application("net.napilnik.someapp.serversimulator.ServerSimulator", getHost(), getPort());
    ...
    public static void main(String[] args) throws IOException {
        host = System.getProperty("host.ip", "127.0.0.1");
